...
% The Ridge estimator scales the OLS estimate by the inverse factor of
% $1+\lambda$, and the Ridge estimator converges to zero when $\lambda$ goes to
% infinity (\textbf{\textit{at least -- and probably only -- when the design
% matrix is orthonormal -- I should look more into this}}).
