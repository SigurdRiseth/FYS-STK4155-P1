...
The squared singular values of the standardized design matrix, $\sigma_i^2/n$, span
...
$\sigma_i^2/n \lesssim \lambda$ and leaves the others untouched, so increasing
...
\begin{figure}[htbp]
    ...
    \caption{Ridge shrinkage factors $d_i = \sigma_i^2/(\sigma_i^2+n\lambda)$
    ...
    to $1$. Dotted, right axis: $\sigma_i^2/n$.}
...
appendix~\ref{app:additional-results}). With more data the variance at a given degree
...
gap of $1.1\times10^{-2}$, momentum at $2.5\times10^{-2}$, and the others above
...
are as large as $1.6$ where scikit-learn's are zero; even after $5\times10^4$
