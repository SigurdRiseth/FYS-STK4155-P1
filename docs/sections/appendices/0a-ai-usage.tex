...
\begin{itemize}
    ...
    \item GitHub Copilot via VS Code, unknown model, September 2026.
\end{itemize}

Claude was used most often, both for code development and for writing the report.
ChatGPT was sometimes used to discuss solutions and writing. GitHub Copilot was
used only rarely through the VS Code ``fix'' interface to address minor warnings.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\columnwidth}{@{}lcX@{}}
        ...
        Introduction & 2 & Authors text; last three paragraphs revised by Claude. \\
        Methods & 2 & Authors text; corrected by Claude. \\
        Implementation & 2 & Authors text; revised by Claude. \\
        Results and discussion & 2 & Authors text; revised and improved by Claude. \\
        Conclusion & 2 & Drafted by the author; revised and improved by Claude. \\
        Appendices & 3 & Drafted by Claude; revised by the author. \\
        \bottomrule
    \end{tabularx}}
\end{table}

For the abstract, with a contribution level of 3, we gave Claude access to the
project repository containing both the source code and the \LaTeX{} source of
the report. The LLM was instructed to review the implementation, results, and
written report before drafting a proposed abstract. We also provided relevant
course literature on writing abstracts and scientific reports, which the LLM
used as guidance when preparing the draft. The abstract was subsequently
reviewed and revised by the author.

The appendices are also assigned level 3 because the LLM was used to help
maintain the documentation of AI/LLM use throughout the project. When using an
LLM, we instructed it to record its contribution in this appendix, including
the relevant section or code file, contribution level, and a brief description
of how the LLM was used. This allowed the appendix to be updated as LLM-assisted
work was performed rather than reconstructed retrospectively. The final appendix
was reviewed and revised by the author to ensure that the reported contribution
levels and descriptions accurately reflect the work performed.
...
\begin{table*}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}l c X@{}}
        ...
        \texttt{degree\_sweep.py} & 3 & Extracted and refactored from our notebooks and generalized. \\
        \texttt{lasso.py} & 0 & \\
